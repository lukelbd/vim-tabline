...
The directory names are always omitted from the tab names. If the file name is more than `g:tabline_charmax` characters long (the default is `12`), the beginning and end of the tab name are truncated and replaced with `·`.
If there are too many tabs open for the window width, the leading and trailing tabs names
